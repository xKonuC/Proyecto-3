    ...
    >
      ...
      >
        <div className="flex w-full max-w-sm sm:max-w-md md:max-w-lg overflow-hidden bg-white rounded-lg shadow-md">
          <div className="flex flex-2 items-center justify-center w-16 bg-blue-500">
            <svg
              aria-hidden="true"
          ...
          <div className="flex-1 px-4 py-2 -mx-3">
            <div className="mx-3">
              <span className="font-semibold text-blue-500">Mensaje de Espera</span>
              <p className="text-sm text-gray-600">{message || 'Esperando respuesta del servidor...'}</p>
            </div>
          </div>
        </div>
      </div>
