...
function SectionsGraduateBase({ title, sections, description = "", customClass = "" }) {
                ...
                <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {sections.map((section, index) => (
                        ...
                        >
                            ...
                            <div className="relative flex h-full rounded-xl items-end border-2 border-orange-main bg-orange-main transition-all ease-in-out duration-100 group-hover:bg-white group-hover:border-orange-main transform group-hover:-translate-x-2 group-hover:-translate-y-2">
                                <div className="p-4 sm:p-6 lg:p-8">
                                    <span className="block group-hover:hidden text-white">
                                        {section.icon}
                                    </span>
                                    <h2 className="mt-4 text-xl font-bold sm:text-2xl text-white group-hover:font-semibold group-hover:text-orange-main">{section.title}</h2>
...
export default SectionsGraduateBase;
