...
const RecordManagement = ({ options, items, filteredItems, setFilteredItems, clearFilteredItems }) => {
    ...
    const handleExport = async () => {
        ...
        const fetchService = new FetchService(url, 'Ficha Académica', showAlert, responseHandler);
        ...
        <>
            ...
            <Navbar
                ...
                secondaryButtons={[
                    {
                        id: 1,
                        label: "Exportar Ficha Académica",
