...
const updateThesisRegistration = async (req, res) => {
  const {
    thesisRegistrationID, studentID, directorID, codirectorID, title,
  } = req.body;
  const updateThesisRegistrationInstance = new UpdateThesisRegistration();
  try {
    await updateThesisRegistrationInstance.updateThesisRegistration(thesisRegistrationID, studentID, directorID, codirectorID, title);
